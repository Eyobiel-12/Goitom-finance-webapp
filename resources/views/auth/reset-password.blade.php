...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Wachtwoord Resetten</title>
    ...
    <div class="min-h-screen">
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-yellow-600 to-yellow-400 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col justify-center items-center p-12">
                    <div class="text-center space-y-6">
                        ...
                        <p class="text-xl text-gray-800">Veilige Wachtwoord Reset</p>
                        <div class="mt-12 space-y-4 text-left max-w-md">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900">Verificatie Bevestigd</h3>
                                    <p class="text-gray-800 text-sm">Je OTP-code is gevalideerd</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900">Kies een Sterk Wachtwoord</h3>
                                    <p class="text-gray-800 text-sm">Gebruik letters, cijfers en symbolen</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 text-sm">Klaar in minder dan een minuut</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
                @livewire('reset-password-multi-step', ['email' => request('email')])
            </div>
        </div>
    </div>
