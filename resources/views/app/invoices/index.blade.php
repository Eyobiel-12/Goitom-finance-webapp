        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex items-center gap-3">
                    <!-- Export Button -->
                    <a href="{{ route('app.invoices.export', ['format' => 'xlsx']) }}" class="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-300 hover:bg-gray-700 hover:border-yellow-400/50 transition-all flex items-center gap-2">
